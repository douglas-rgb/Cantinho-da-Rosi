...
function mostrarPix(data) {
  ...
  div.innerHTML = ` <div style=" position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.85); 
  display:flex; 
  ...
  <img src="data:image/png;base64,${pix.qr_code_base64}" style="width:100%; 
  ...
  height:80px; 
  margin-top:5px; 
  padding:8px; border-radius:8px; " >${pix.qr_code}</textarea> 
  ...
  border-radius:8px; 
  cursor:pointer; 
  " onclick="this.closest('div').parentElement.remove()" > Fechar </button> 
  </div> 
  </div> `;
